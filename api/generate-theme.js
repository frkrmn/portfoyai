...
const siteConfigSchema = JSON.parse(readFileSync(new URL("../server/site-config.schema.json", import.meta.url), "utf8"));
...
const siteConfigSystemPrompt = [
  ...
  "Select from the user's stated positioning; do not default to warm-editorial or bold-luxury. When the user explicitly says they have no special style preference or asks for a standard/general-purpose site, select clean-modern.",
