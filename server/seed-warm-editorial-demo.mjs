...
const { data: site, error: siteError } = await supabase
  ...
  .upsert({
    ...
    phone: warmEditorialDemoConfig.content.phone || null,
    email: warmEditorialDemoConfig.content.email || null,
    address: warmEditorialDemoConfig.content.address || null,
    region_focus: warmEditorialDemoConfig.content.regionFocus || null,
    map_url: warmEditorialDemoConfig.content.mapUrl || null,
