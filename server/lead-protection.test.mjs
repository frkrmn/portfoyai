...
const defaults = { verifyCaptcha: async () => ({ success: true, errors: [] }), claimRate: async () => true, duplicateCheck: async () => false, hashIp: () => "hash", dispatchNotifications: async () => [], recordConversion: async () => {} };
