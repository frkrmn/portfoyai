    ...
    <article className="group min-w-0">
      ...
      <div className="pt-5">
        ...
        <div className="mt-5 flex items-center gap-4 border-t border-black/10 pt-4 text-xs">
          ...
          <strong className="ml-auto whitespace-nowrap font-medium">{formatListingPrice(listing)}</strong>
        </div>
      </div>
    </article>
  );
