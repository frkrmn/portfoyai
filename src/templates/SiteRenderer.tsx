...
function LocalizedSite({ config, Component, listingStatus }: { config: ReturnType<typeof createTemplateConfig>; Component: ReturnType<typeof getTemplateFamily>["Home"]; listingStatus?: string }) {
